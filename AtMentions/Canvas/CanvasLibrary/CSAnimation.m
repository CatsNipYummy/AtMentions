...
+ (void)performAnimationOnView:(UIView *)view duration:(NSTimeInterval)duration delay:(NSTimeInterval)delay {
    ...
    [UIView animateKeyframesWithDuration:duration/6 delay:delay options:0 animations:^{
        //End
        view.transform = CGAffineTransformMakeTranslation(0, 3);
    } completion:^(BOOL finished) {
        [UIView animateKeyframesWithDuration:duration/25 delay:0 options:0 animations:^{
            // End
            view.transform = CGAffineTransformMakeTranslation(0, 9);
        } completion:^(BOOL finished) {
            [UIView animateKeyframesWithDuration:duration/30 delay:0 options:0 animations:^{
                // End
                view.transform = CGAffineTransformMakeTranslation(0, 5);
            } completion:^(BOOL finished) {
